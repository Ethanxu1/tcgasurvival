...
<form action=\"../../../cgi-bin/tcga_expr/survivalfig.py\" method=\"POST\">
    <table summary=\"RNASeq expression profile\" class=nonbordered>
        <tr>
            <td>
                ...
                <input type=\"text\" name=\"gene\" value=\"{gene}\" title=\"gene\" size=20 id=\"gene\">
...
os.system(f"Rscript genesurvplot.r {cohort} {gene} {procid}")

fn2 = '_n'

print (f'<img src=\"outfig.py?name={procid}.jpg\"  alt=\"{procid}.jpg\">')
print (f'<img src=\"outfig.py?name={procid}{fn2}.jpg\"  alt=\"{procid}.jpg\">')
